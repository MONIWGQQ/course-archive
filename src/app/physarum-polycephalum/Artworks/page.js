...
const ArtworksGallery = () => {
  ...
  useEffect(() => {
    ...
    function animate(currentTime) {
      ...
      bgGradient.addColorStop(0, 'rgba(120,0,20,0.85)'); // 中心红色
      bgGradient.addColorStop(0.45, 'rgba(60,0,60,0.7)');
      bgGradient.addColorStop(0.7, 'rgba(0,0,80,0.85)'); // 四周蓝色
